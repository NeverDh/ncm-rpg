...
**Restrições:** **não editar código nem artefatos de implementação** (`src/`, Prisma, `package.json`, testes, etc.) — ver `AGENTS.md` §7.1; não aprovar dependências novas (competência do TECH_LEAD + ADR).
