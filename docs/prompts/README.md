# Prompts copiáveis — índice

**Preferência:** no Agent Chat use **`/rpg-product`**, **`/rpg-bot-copy`**, **`/rpg-dev`**, **`/rpg-session`** ou **`/rpg-bootstrap`**, etc. — comandos em **`.cursor/commands/`**. Esta pasta é **alternativa** para quem quer colar texto.

Se usar cópia manual: anexe `@AGENTS.md`.

**Novo chat sem histórico:** veja **[../PROMPT_NOVO_CHAT.md](../PROMPT_NOVO_CHAT.md)** e **[../COMO-USAR-AGENTS.md](../COMO-USAR-AGENTS.md)**.

**Um agente só:** uma linha da tabela — não precisa usar `INICIO-SESSAO.md`.
